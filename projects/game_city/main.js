...
let arrayGameList = Object.entries(progressGame)//массивы игроков
      .filter(item => item[0] === 'firstPerson'|| item[0] === 'secondPerson'),
      currentArray = randomGenerator(arrayGameList),// текущий массив
      currentCity = randomGenerator(currentArray[1]),//текущий город
      currentMove = () => console.log(`${currentArray[0]}: ${currentCity}`); //вывод данных
...
function deleteCurrentCity(cWord) {
    ...
    commonCitiesList.splice(index, 1);    
...
definitionCurrentCity(currentCity);
console.log(progressGame.firstPerson);
console.log(progressGame.secondPerson);
currentMove();
deleteCurrentCity(currentCity);
console.log(commonCitiesList);
definitionCurrentCity(currentCity);
